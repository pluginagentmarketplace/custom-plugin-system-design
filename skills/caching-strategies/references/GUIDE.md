...
This guide provides comprehensive documentation for the **caching-strategies** skill in the custom-plugin-system-design plugin.
...
```bash
# Invoke the skill
claude "caching-strategies - [your task description]"

# Example
claude "caching-strategies - analyze the current implementation"
```
...
def implement_caching_strategies(input_data):
    """
    Implement caching-strategies functionality.
