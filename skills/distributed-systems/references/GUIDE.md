...
This guide provides comprehensive documentation for the **distributed-systems** skill in the custom-plugin-system-design plugin.
...
```bash
# Invoke the skill
claude "distributed-systems - [your task description]"

# Example
claude "distributed-systems - analyze the current implementation"
```
...
def implement_distributed_systems(input_data):
    """
    Implement distributed-systems functionality.
