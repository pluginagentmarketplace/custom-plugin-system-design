...
This guide provides comprehensive documentation for the **microservices-design** skill in the custom-plugin-system-design plugin.
...
```bash
# Invoke the skill
claude "microservices-design - [your task description]"

# Example
claude "microservices-design - analyze the current implementation"
```
...
def implement_microservices_design(input_data):
    """
    Implement microservices-design functionality.
