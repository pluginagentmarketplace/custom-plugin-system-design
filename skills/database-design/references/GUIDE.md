...
This guide provides comprehensive documentation for the **database-design** skill in the custom-plugin-system-design plugin.
...
```bash
# Invoke the skill
claude "database-design - [your task description]"

# Example
claude "database-design - analyze the current implementation"
```
...
def implement_database_design(input_data):
    """
    Implement database-design functionality.
