...
This guide provides comprehensive documentation for the **event-driven** skill in the custom-plugin-system-design plugin.
...
```bash
# Invoke the skill
claude "event-driven - [your task description]"

# Example
claude "event-driven - analyze the current implementation"
```
...
def implement_event_driven(input_data):
    """
    Implement event-driven functionality.
